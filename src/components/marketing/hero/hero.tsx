  ...
  return (
    <section >
      <div className="relative h-full py-10">
          ...
          <div className=" grid grid-cols-1">
            ...
            <div className="flex flex-col items-center gap-6 pb-8 text-center">
              <Link href="/">
                ...
                >
                  <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                    <span>✨Quiz coming soon: How compassionate are you? </span>
                    <ArrowRightIcon className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
                  </AnimatedShinyText>
                </div>
              </Link>

              <div className="relative flex flex-col gap-4 sm:items-center md:items-center lg:flex-row">
              ...
              <p className="max-w-[64rem] text-balance text-lg tracking-tight text-black dark:text-white md:text-xl">
                ...
                <br />
                100% free consultation, and tailored experience.
              </p>
        ...
        {/* <div className="relative mx-auto flex w-full max-w-[1000px] items-center justify-center content-center gap-2">
        <Image
            src="/images/img_5.png"
            width={150}
            height={150}
